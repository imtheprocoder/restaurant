...
const reducer = (state, action) => {
    ...
    switch(type) {
        ...
        case 'ALL_STATUS_FETCHED': return {...state, allStatus: payload};

        case 'ORDERS_FETCHED': return {...state, orders: payload};
  ...
  <div className={classes.container}>
...

    {
        allStatus && (
            ...
            <Link to="/orders" className={!filter ? classes.selected : ''}>All</Link>
                {allStatus.map(state => (
